...
coef_i = abs(np.array([0.000103306, -0.077777358, -0.080911916, -0.09090267, -0.092865159]))
coef_e = abs(np.array([0.000195955, -0.031071886, -0.089689408, -0.091366085, -0.090797264]))
